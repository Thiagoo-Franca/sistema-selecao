    ...
    return (
      <div className="container mx-auto p-4 md:p-8">
        ...
        <div className="mb-4 rounded-md bg-destructive/10 p-4 text-destructive">
          ...
          <p>
            Você não tem permissão para acessar esta página. Apenas administradores e professores
            podem gerar documentos.
          </p>
        </div>
      ...
      <div className="overflow-hidden rounded-lg bg-card shadow-md">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div>
              <div className="mb-6">
                <h2 className="mb-2 text-xl font-semibold">Geração de Documentos Oficiais</h2>
                <p className="text-muted-foreground">
                  Gere e baixe os documentos oficiais da banca examinadora conforme os padrões da
                  UFBA.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg border p-4">
                  ...
                  <p className="mb-3 text-sm text-muted-foreground">
                    Declaração para membros da banca examinadora.
                  </p>
                  ...
                  {eligibleParticipants.length > 0 && (
                    <div className="mb-3">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setSelectedParticipant(value ? Number(value) : null)
                        }
                      >
                ...
                <div className="rounded-lg border p-4">
                  ...
                  <p className="mb-3 text-sm text-muted-foreground">
                    Declaração de orientação para o orientador.
                  </p>
                  <div className="flex gap-2">
                    <Button
                      variant="outline"
                ...
                <div className="rounded-lg border bg-blue-50/50 p-4 dark:bg-blue-950/20">
                  ...
                  <p className="mb-3 text-sm text-muted-foreground">
                    Envie todas as declarações para o CEAG (Colegiado de Ensino, Pesquisa e
                    Extensão) por email.
                  </p>
                  <Button
                    variant="default"
            ...
            <div>
              <div className="mb-4">
                ...
                {previewType && (
                  <p className="text-sm text-muted-foreground">Visualizando: {previewType}</p>
                )}
              </div>
              ...
              <div className="rounded-lg border">
                {previewUrl ? (
                  ...
                  <div className="flex h-[600px] items-center justify-center rounded-lg bg-muted/20 text-muted-foreground">
