    ...
    return (
        <div className="container mx-auto p-4 md:p-8">
            ...
            <div className="flex flex-row items-center justify-between mb-6">
                ...
                <Button className="" onClick={() => navigate(`/doutorado/${candidato.id}/avaliacao`)}>
                    Avaliar
                </Button>
            </div>
            <section>
            ...
            <section>
                <div className="grid grid-cols-3 gap-4">
                    ...
                    </div>
                    {
                        ...
                        // falta copia documento com foto e impressão digital (apenas para brasileiras)
                    }
                    ...
                    <div>
                        <h3 className="font-semibold">HISTÓRICO ACADÊMICO DO CURSO DE GRADUAÇÃO</h3>
                    ...
                    <div>
                        <h3 className="font-semibold">CÓPIA DE DIPLOMA DE MESTRADO OU DECLARAÇÃO DE CONCLUINTE</h3>
                        <a href={candidato.copiaDiplomaMestrado} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:underline">
                            {candidato.copiaDiplomaMestrado}
                        </a>
                    </div>
                    <div>
                        <h3 className="font-semibold">Histórico acadêmico do curso de mestrado</h3>
                        <a href={candidato.historicoMestrado} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:underline">
                            {candidato.historicoMestrado}
                        </a>
                    </div>
                    <div>
                        <h3 className="font-semibold">Nome da universidade/faculdade onde realizou mestrado</h3>
                        <p className="text-muted-foreground">
                            {candidato.nomeUniversidadeMestrado}
                        </p>
                    </div>
                    <div>
                        <h3 className="font-semibold">Nome do curso de mestrado</h3>
                        <p className="text-muted-foreground">
                            {candidato.nomeCursoMestrado}
                        </p>
                    </div>
                    ...
                    <div>
                        <h3 className="font-semibold">ANTEPROJETO DE TESE</h3>
                        <a href={candidato.anteprojetoTese} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:underline">
                            {candidato.anteprojetoTese}
                        </a>
                    </div>
                    <div>
                        <h3 className="font-semibold">Conceito CAPES do programa do curso de mestrado</h3>
                        <p className="text-muted-foreground">
                            {candidato.conceitoCapesMestrado}
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                    <div>
                        <h3 className="font-semibold">Primeira opção de orientador(a)</h3>
                        <p className="text-muted-foreground">
                            {candidato.primeiraOpcaoOrientador}
                        </p>
                    </div>
                    <div>
                        <h3 className="font-semibold">Segunda opção de orientador(a)</h3>
                        <p className="text-muted-foreground">
                            {candidato.segundaOpcaoOrientador}
                        </p>
                    </div>
                    <div>
                        <h3 className="font-semibold">Terceira opção de orientador(a)</h3>
                        <p className="text-muted-foreground">
